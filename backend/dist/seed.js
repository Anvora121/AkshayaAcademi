...
const seedDatabase = async () => {
    ...
    try {
        ...
        // ── Feedback ───────────────────────────────────────────
        await UniversityFeedback_1.UniversityFeedback.deleteMany({});
        await UniversityFeedback_1.UniversityFeedback.insertMany(feedbackSeed);
        console.log(`✅ Feedback seeded: ${feedbackSeed.length} entries`);
        // ── Placements ─────────────────────────────────────────
        await PlacementOffer_1.PlacementOffer.deleteMany({});
        await PlacementOffer_1.PlacementOffer.insertMany(placementSeed);
